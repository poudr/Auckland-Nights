...
## Recent Changes
- **Feb 10, 2026**: Custom staff roster colors (hex); Admin panel restricted to Director/Executive only; Pre-seeded department access role mappings (Police, Fire, EMS); Removed AOS ranks from seed (manual setup); QID system for Police roster
